...
module WebTest
   module Pm
     module ProductReview
          ...
          describe 'review report page' do
          before :all do
            ...
            @review_report_page = @page_container.review_report_page
            @review_report_page.to_this_page
          end
        ...
        it 'menu page test' do
          #given
          review_report_title = @pm_profiles['product_review']['review_report_title']
          #when
          actual_top_title = @review_report_page.top_title
          #then
          actual_top_title.should == review_report_title
        end
