   ...
   module Pm
     module Test
        ...
        before :all do
          ...
          @test_report_page = @page_container.test_report_page
          @test_report_page.to_this_page
        end
        ...
        it 'menu page test' do
          #given
          test_report_title = @pm_profiles['test']['test_report_title']
          #when
          actual_top_title = @test_report_page.top_title
          #then
          actual_top_title.should == test_report_title
        end
