   ...
   module Pm
     module Test
          ...
          before :all do
            ...
            @bug_query_page = @page_container.bug_query_page
            @bug_query_page.to_this_page
          end
        ...
        it 'menu page test' do
          #given
          bug_query_title = @pm_profiles['test']['bug_query_title']
          #when
          actual_top_title = @bug_query_page.top_title
          #then
          actual_top_title.should == bug_query_title
        end
