...
module WebDriver
  module Hl
    module Page
      module ReviewManage
        class ProjectRiskPage < Common::BasePage
         ...
         def to_this_page
           ...
           project_risk = @page_profiles['review_manage']['project_risk']
           menu_click high_level_view
           #menu_click_for_hide review_manage,project_risk
           show_menu_by_js("hl_eg")
           menu_click project_risk
           sleep 2
         end
